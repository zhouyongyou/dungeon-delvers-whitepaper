...
**升階規則**:
| 升級目標 | 需要材料 | 升級費用 (ETH) | 大成功 | 普通成功 | 部分返還 | 完全失敗 |
|----------|----------|----------------|---------|----------|----------|----------|
| **1★→2★** | 5個 1★ NFT | 0.001 | 8% (得2個) | 77% (得1個) | 13% (返還2個) | 2% (全失) |
| **2★→3★** | 4個 2★ NFT | 0.002 | 6% (得2個) | 69% (得1個) | 20% (返還2個) | 5% (全失) |
| **3★→4★** | 3個 3★ NFT | 0.004 | 5% (得2個) | 48% (得1個) | 37% (返還1個) | 10% (全失) |
| **4★→5★** | 2個 4★ NFT | 0.01 | 6% (得2個) | 34% (得1個) | 46% (返還1個) | 14% (全失) |
